        ...
        <div class="card">
            <div class="card-header bg-primary">
                <div class="d-flex justify-content-between">
                    <p class="card-title text-white my-2"><i class="ti-book mr-3"></i>Edit Buku</p>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        {!! Form::model($buku, ['method' => 'PATCH', 'enctype' => 'multipart/form-data','route' => ['buku.update', $buku->id]]) !!}
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9 offset-sm-3 mb-4">
                                <img src='{{ url("images/cover/$buku->cover") }}' class="border rounded">
                            </div>
                            @endif
                        </div>
                        <div class="form-group row mb-3">
